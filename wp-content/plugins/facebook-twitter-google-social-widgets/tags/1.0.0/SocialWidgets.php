...
Plugin URI: http://www.ab-weblog.com/en/wordpress-social-widgets-plug-in/
Description: A simple plugin that displays the most important social widgets from Facebook, Twitter and Google+ below your posts. Very easy to setup: just activate the plug-in and the social widgets are displayed immediately - no complicated configuration!
Version: 1.0.0
