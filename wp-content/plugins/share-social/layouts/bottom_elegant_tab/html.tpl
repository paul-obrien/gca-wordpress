...
<script type="text/javascript">
jQuery('.bar_btm_ele_tb .cunjo_tooltip').poshytip({
...
.bar_btm_ele_tb ul.btm_ele_tb li.cunjo_socials_holder_btm_ele_tb:hover {
	background-color: transparent !important;
}
.bar_btm_ele_tb ul.btm_ele_tb li.cunjo_socials a.email, .bar_btm_ele_tb ul.btm_ele_tb li.cunjo_credits_btm_ele_tb a, 
.bar_btm_ele_tb ul.btm_ele_tb li.close_btm_ele_tb, .bar_btm_ele_tb ul.btm_ele_tb li.container_btm_ele_tb, .show_btm_ele_tb {
...
#{$id}_modal .cunjo_modal_body a .sprite {
	background-image: url({$website}layouts/images/icons-elegant-32.png) !important;
}
...
<div id="{$id}" class="Share-bar bar_btm_ele_tb {$position}_btm_ele_tb {if isset($icons)}{$icons}{else}elegant{/if}_btm_ele_tb {if $counter eq 'yes'}counter_format{/if}">
    <ul class="btm_ele_tb">
    		<li class="close_btm_ele_tb"><span class="iconz-contract"></span></li>
        {if $nocredits eq FALSE}
            <li class="space_btm_ele_tb"></li>
        {else}
            <li class="cunjo_credits_btm_ele_tb {if isset($tooltip) && $tooltip == 'yes'}cunjo_tooltip{/if}" title="!Share"><a href="http://share.cunjo.com" target="_blank" class="cunjo_more_modal"><span class="iconz-cunjo"></span></a></li>
        {/if}
        {if isset($socials) && $socials != ''}
        <li class="cunjo_socials_holder_btm_ele_tb cunjo_pos_left">
        	<ul class="cunjo_socials_btm_ele_tb">
...
<div class="show_btm_ele_tb"><span class="iconz-expand"></span></div>
<script type="text/javascript">
...
{/literal}
	...
	jQuery(document.body).on('hover', '.tip-inner .cunjo_socials_btm_ele_tb li', function() { jQuery('.cunjo_tooltip').poshytip('show'); });
	{/literal}
...
<div id="{$id}_modal_email" class="cunjo_modal" style="display: none;">
    ...
    <div class="cunjo_modal_body">
    	 <div id="sendemail" class="send-email_btm_ele_tb">
         <form id="cunjo_share_email">
            ...
            <div class="cunjo-form-row">
                ...
                <div id="submitemail_btm_ele_tb" class="cunjo-email-btn"><span class="iconz-mail-send"></span> <span>{#email_send#}</span></div>
