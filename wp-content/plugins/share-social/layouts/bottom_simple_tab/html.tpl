...
<div id="{$id}" class="Share-bar bar_btm_simple_tb {$shadow}_btm_simple_tb {$icons}_btm_simple_tb maxwidth_btm_simple_tb">
    <ul class="btm_simple_tb">
        ...
        <li class="cunjo_socials_holder_btm_simple_tb {$socials_pos}">
    ...
    <div class="cunjo_modal_body">
         ...
         <form id="cunjo_share_email">
            ...
            <div class="cunjo-form-row">
                ...
                <div id="submitemail_btm_simple_tb" class="cunjo-email-btn"><span class="iconz-mail-send"></span> <span>{#email_send#}</span></div>
