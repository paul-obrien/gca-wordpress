...
<div id="{$id}" class="Share-bar bar_btm_tb {$position}_btm_tb {$icons}_btm_tb {if $width eq '100'}maxwidth_btm_tb{/if}">
    <ul class="btm_tb">
        ...
        {else}
            <li class="cunjo_credits_btm_tb {if isset($tooltip) && $tooltip == 'yes'}cunjo_tooltip{/if}" title="!Share"><a href="http://share.cunjo.com" target="_blank" class="cunjo_more_modal"><span class="iconz-cunjo"></span></a></li>
        {/if}
        {if isset($message) && $message != ''}
        <li class="cunjo_messages_holder_btm_tb {$message_pos}">
        ...
        <li class="cunjo_socials_holder_btm_tb {$socials_pos}">
    ...
    <div class="cunjo_modal_body">
         ...
         <form id="cunjo_share_email">
            ...
            <div class="cunjo-form-row">
                ...
                <div id="submitemail_btm_tb" class="cunjo-email-btn"><span class="iconz-mail-send"></span> <span>{#email_send#}</span></div>
