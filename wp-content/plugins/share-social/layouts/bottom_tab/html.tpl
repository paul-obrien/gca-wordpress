...
<div id="{$id}" class="Share-bar bar_btm_tb {$position}_btm_tb {$icons}_btm_tb {if $width eq '100'}maxwidth_btm_tb{/if}">
    <ul class="btm_tb">
        ...
        {else}
            <li class="cunjo_credits_btm_tb {if isset($tooltip) && $tooltip == 'yes'}cunjo_tooltip{/if}" title="!Share"><a href="http://cunjo.com" target="_blank" class="cunjo_more_modal"><span class="iconz-cunjo"></span></a></li>
        {/if}
