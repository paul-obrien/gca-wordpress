...
<style>
.bar_counter_btns ul.counter_btns li.cunjo_socials_holder_counter_btns:hover {
	background-color: transparent !important;
}
.bar_counter_btns .cunjo_socials_counter_btns .cunjo_messages_holder_counter_btns, .bar_counter_btns ul.counter_btns li.cunjo_socials a.email, .bar_counter_btns ul.counter_btns li.cunjo_credits_counter_btns a, 
.bar_counter_btns ul.counter_btns li.close_counter_btns, .bar_counter_btns ul.counter_btns li.container_counter_btns, .show_counter_btns {
	color: {$textcolor} !important;
}
.bar_counter_btns .sh-counter {
...
#{$id}_modal .cunjo_modal_body a .sprite {
	background-image: url({$website}layouts/images/icons-metro-32.png) !important;
}
...
#{$id} .cunjo_messages_holder_counter_btns {
	font-size: 12px;
	font-weight: bold;
...
<div id="{$id}" class="Share-bar bar_counter_btns icons_counter_btns {if $counter eq 'yes'}counter_format{/if}">
    <ul class="counter_btns">
        {if isset($socials) && $socials != ''}
        <li class="cunjo_socials_holder_counter_btns">
        	<ul class="cunjo_socials_counter_btns">
            	{if isset($message) && $message != ''}
                <li class="cunjo_messages_holder_counter_btns {$message_pos}">
                    {$message}
                </li>
                {/if}
                ...
                {if $nocredits eq FALSE}
                    <li class="space_counter_btns"></li>
                {else}
                    <li class="cunjo_credits_counter_btns {if isset($tooltip) && $tooltip == 'yes'}cunjo_tooltip{/if}" title="!Share"><a href="http://share.cunjo.com" target="_blank" class="cunjo_more_modal"></a></li>
                {/if}
            </ul>
        </li>
        {/if}
...
{/literal}
	...
	jQuery(document.body).on('hover', '.tip-inner .cunjo_socials_counter_btns li', function() { jQuery('.cunjo_tooltip').poshytip('show'); });
	{/literal}
...
<div id="{$id}_modal_email" class="cunjo_modal" style="display: none;">
    ...
    <div class="cunjo_modal_body">
    	 <div id="sendemail" class="send-email_counter_btns">
         <form id="cunjo_share_email">
            ...
            <div class="cunjo-form-row">
                ...
                <div id="submitemail_counter_btns" class="cunjo-email-btn"><span class="iconz-mail-send"></span> <span>{#email_send#}</span></div>
