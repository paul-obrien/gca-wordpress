    ...
    <ul class="counter_btns">
        ...
        <li class="cunjo_socials_holder_counter_btns">
        	<ul class="cunjo_socials_counter_btns">
                ...
                {else}
                    <li class="cunjo_credits_counter_btns {if isset($tooltip) && $tooltip == 'yes'}cunjo_tooltip{/if}" title="!Share"><a href="http://cunjo.com" target="_blank" class="cunjo_more_modal"></a></li>
                {/if}
            </ul>
        </li>
        {/if}
