    ...
    <ul class="inline_btns">
        ...
        <li class="cunjo_socials_holder_inline_btns">
        	<ul class="cunjo_socials_inline_btns">
                ...
                {else}
                    <li class="cunjo_credits_inline_btns {if isset($tooltip) && $tooltip == 'yes'}cunjo_tooltip{/if}" title="!Share"><a href="http://cunjo.com" target="_blank" class="cunjo_more_modal"></a></li>
                {/if}
            </ul>
        </li>
        {/if}
