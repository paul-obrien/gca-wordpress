...
<script type="text/javascript">
jQuery('.bar_left_ele_tb .cunjo_tooltip').poshytip({
...
<style>
.bar_left_ele_tb, .show_left_ele_tb {
	background-color: {$bgcolor}; 
	margin-left: -{$offleft}px;
}
.show_left_ele_tb {
	background-color: {$bgcolor}; 
	border-color: {$bgcolor};
}
.bar_left_ele_tb ul.left_ele_tb li.cunjo_socials_holder_left_ele_tb:hover {
	background-color: transparent !important;
}
.bar_left_ele_tb ul.left_ele_tb li.cunjo_socials a.email, .bar_left_ele_tb ul.left_ele_tb li.cunjo_credits_left_ele_tb a, 
.bar_left_ele_tb ul.left_ele_tb li.close_left_ele_tb, .bar_left_ele_tb ul.left_ele_tb li.container_left_ele_tb, .show_left_ele_tb {
	color: {$textcolor} !important;
}
.bar_left_ele_tb .sh-counter {
	background-color: {$bgcolor};
	color: {$textcolor} !important;
}
#{$id} ul {
...
<div id="{$id}" class="Share-bar bar_left_ele_tb {$position}_left_ele_tb {if isset($icons)}{$icons}{else}elegant{/if}_left_ele_tb">
    <ul class="left_ele_tb">
        {if isset($socials) && $socials != ''}
        <li class="cunjo_socials_holder_left_ele_tb">
        	<ul class="cunjo_socials_left_ele_tb">
...
<div class="show_left_ele_tb {$position}_left_ele_tb"><span class="iconz-expand"></span></div>
<script type="text/javascript">
...
{/literal}
	...
	jQuery(document.body).on('hover', '.tip-inner .cunjo_socials_left_ele_tb li', function() { jQuery('.cunjo_tooltip').poshytip('show'); });
	{/literal}
...
<div id="{$id}_modal_email" class="cunjo_modal" style="display: none;">
    ...
    <div class="cunjo_modal_body">
    	 <div id="sendemail" class="send-email_left_ele_tb">
         <form id="cunjo_share_email">
            ...
            <div class="cunjo-form-row">
                ...
                <div id="submitemail_left_ele_tb" class="cunjo-email-btn"><span class="iconz-mail-send"></span> <span>{#email_send#}</span></div>
