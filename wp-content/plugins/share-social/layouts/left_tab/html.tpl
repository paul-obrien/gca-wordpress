...
<script type="text/javascript">
jQuery('.bar_left_tb .cunjo_tooltip').poshytip({
...
.bar_left_tb ul.left_tb li:hover {
	background-color: {$bgcolor} !important;
}
.bar_left_tb ul.left_tb li.cunjo_socials_holder_left_tb:hover {
	background-color: transparent !important;
}
.bar_left_tb li.cunjo_messages_holder_left_tb li.cunjo_message_left_tb, .bar_left_tb li.cunjo_messages_holder_left_tb li.cunjo_message_left_tb a, .bar_left_tb ul.left_tb li.cunjo_socials a.email,
.bar_left_tb ul.left_tb li.cunjo_credits_left_tb a, .bar_left_tb ul.left_tb li.close_left_tb, .bar_left_tb ul.left_tb li.container_left_tb, .show_left_tb {
	color: {$textcolor} !important;
}
.bar_left_tb li.cunjo_messages_holder_left_tb li.cunjo_message_btn_left_tb .cunjo_message_btn {
	background-color: {$messagebtncolor};
	border-color: {$messagebtncolor};
	color: {$messagebtntext} !important;
}
.bar_left_tb ul.left_tb li.cunjo_messages_holder_left_tb li.cunjo_message_btn_left_tb:hover {
	background-color: transparent !important;
}
#{$id} ul {
...
<div id="{$id}" class="Share-bar bar_left_tb {$position}_left_tb {$icons}_left_tb">
    <ul class="left_tb">
        {if isset($socials) && $socials != ''}
        <li class="cunjo_socials_holder_left_tb">
        	<ul class="cunjo_socials_left_tb">
        ...
        {if $nocredits eq FALSE}
            <li class="space_left_tb"></li>
        {else}
            <li class="cunjo_credits_left_tb {if isset($tooltip) && $tooltip == 'yes'}cunjo_tooltip{/if}" title="!Share"><a href="http://share.cunjo.com" target="_blank" class="cunjo_more_modal"><span class="iconz-cunjo"></span></a></li>
        {/if}
        <li class="close_left_tb"><span class="iconz-contract"></span></li>
    </ul>
</div>
<div class="show_left_tb"><span class="iconz-expand"></span></div>
<script type="text/javascript">
...
{/literal}
	...
	jQuery(document.body).on('hover', '.tip-inner .cunjo_socials_left_tb li', function() { jQuery('.cunjo_tooltip').poshytip('show'); });
});
{/literal}
</script>
<!--more modal-->
...
<div id="{$id}_modal_email" class="cunjo_modal" style="display: none;">
    ...
    <div class="cunjo_modal_body">
    	 <div id="sendemail" class="send-email_left_tb">
         <form id="cunjo_share_email">
            ...
            <div class="cunjo-form-row">
                ...
                <div id="submitemail_left_tb" class="cunjo-email-btn"><span class="iconz-mail-send"></span> <span>{#email_send#}</span></div>
