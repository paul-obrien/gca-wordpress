...
<div id="{$id}" class="Share-bar bar_left_tb {$position}_left_tb {$icons}_left_tb">
    <ul class="left_tb">
        ...
        {else}
            <li class="cunjo_credits_left_tb {if isset($tooltip) && $tooltip == 'yes'}cunjo_tooltip{/if}" title="!Share"><a href="http://cunjo.com" target="_blank" class="cunjo_more_modal"><span class="iconz-cunjo"></span></a></li>
        {/if}
