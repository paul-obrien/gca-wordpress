...
<div id="{$id}" class="Share-bar bar_rgt_tb {$position}_rgt_tb {$icons}_rgt_tb">
    <ul class="rgt_tb">
        ...
        {if $nocredits eq FALSE}
            <li class="space_rgt_tb"></li>
        {else}
            <li class="cunjo_credits_rgt_tb {if isset($tooltip) && $tooltip == 'yes'}cunjo_tooltip{/if}" title="!Share"><a href="http://share.cunjo.com" target="_blank" class="cunjo_more_modal"><span class="iconz-cunjo"></span></a></li>
        {/if}
    ...
    <div class="cunjo_modal_body">
         ...
         <form id="cunjo_share_email">
            ...
            <div class="cunjo-form-row">
                ...
                <div id="submitemail_rgt_tb" class="cunjo-email-btn"><span class="iconz-mail-send"></span> <span>{#email_send#}</span></div>
