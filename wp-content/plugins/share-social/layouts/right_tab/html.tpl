...
<div id="{$id}" class="Share-bar bar_rgt_tb {$position}_rgt_tb {$icons}_rgt_tb">
    <ul class="rgt_tb">
        ...
        {else}
            <li class="cunjo_credits_rgt_tb {if isset($tooltip) && $tooltip == 'yes'}cunjo_tooltip{/if}" title="!Share"><a href="http://cunjo.com" target="_blank" class="cunjo_more_modal"><span class="iconz-cunjo"></span></a></li>
        {/if}
