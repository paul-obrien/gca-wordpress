...
#{$id} .cunjo_messages_holder_tiny_btns {
	font-size: 12px;
	font-weight: bold;
...
<div id="{$id}" class="Share-bar bar_tiny_btns {$icons}_tiny_btns {if $counter eq 'yes'}counter_format{/if}">
    <ul class="tiny_btns">
        {if isset($socials) && $socials != ''}
        <li class="cunjo_socials_holder_tiny_btns">
        	<ul class="cunjo_socials_tiny_btns">
            	{if isset($message) && $message != ''}
                <li class="cunjo_messages_holder_tiny_btns {$message_pos}">
                    {$message}
                </li>
                {/if}
    ...
    <div class="cunjo_modal_body">
         ...
         <form id="cunjo_share_email">
            ...
            <div class="cunjo-form-row">
                ...
                <div id="submitemail_tiny_btns" class="cunjo-email-btn"><span class="iconz-mail-send"></span> <span>{#email_send#}</span></div>
