...
<script type="text/javascript">
jQuery('.bar_top_simple_tb .cunjo_tooltip').poshytip({
...
.bar_top_simple_tb ul.top_simple_tb li:hover {
	background-color: {$bgcolor} !important;
}
.bar_top_simple_tb ul.top_simple_tb li.cunjo_socials_holder_top_simple_tb:hover {
	background-color: transparent !important;
}
.bar_top_simple_tb li.cunjo_messages_holder_top_simple_tb li.cunjo_message_top_simple_tb, .bar_top_simple_tb li.cunjo_messages_holder_top_simple_tb li.cunjo_message_top_simple_tb a, .bar_top_simple_tb ul.top_simple_tb li.cunjo_socials a.email,
.bar_top_simple_tb ul.top_simple_tb li.cunjo_credits_top_simple_tb a, .bar_top_simple_tb ul.top_simple_tb li.close_top_simple_tb, .bar_top_simple_tb ul.top_simple_tb li.container_top_simple_tb, .show_top_simple_tb {
	color: {$textcolor} !important;
}
.bar_top_simple_tb li.cunjo_messages_holder_top_simple_tb li.cunjo_message_btn_top_simple_tb .cunjo_message_btn {
	background-color: {$messagebtncolor};
	border-color: {$messagebtncolor};
	color: {$messagebtntext} !important;
}
.bar_top_simple_tb ul.top_simple_tb li.cunjo_messages_holder_top_simple_tb li.cunjo_message_btn_top_simple_tb:hover {
	background-color: transparent !important;
}
#{$id} ul {
...
<div id="{$id}" class="Share-bar bar_top_simple_tb {$shadow}_top_simple_tb {$icons}_top_simple_tb maxwidth_top_simple_tb" showat="{$showat}">
    <ul class="top_simple_tb">
    		<li class="close_top_simple_tb"><span class="iconz-contract"></span></li>
        {if $nocredits eq FALSE}
            <li class="space_top_simple_tb"></li>
        {else}
            <li class="cunjo_credits_top_simple_tb {if isset($tooltip) && $tooltip == 'yes'}cunjo_tooltip{/if}" title="!Share"><a href="http://share.cunjo.com" target="_blank" class="cunjo_more_modal"><span class="iconz-cunjo"></span></a></li>
        {/if}
        {if isset($message) && $message != ''}
        <li class="cunjo_messages_holder_top_simple_tb {$message_pos}">
        	<ul class="cunjo_messages_top_simple_tb">
            	<li class="cunjo_message_icon {$messageicon}"></li>
                <li class="cunjo_message_top_simple_tb">
                	<div class="cunjo_message_inner_top_simple_tb">
                        {$message}
                	</div>
                </li>
                <li class="cunjo_message_btn_top_simple_tb">
        ...
        <li class="cunjo_socials_holder_top_simple_tb {$socials_pos}">
        	<ul class="cunjo_socials_top_simple_tb">
...
<div class="show_top_simple_tb"><span class="iconz-expand"></span></div>
<script type="text/javascript">
...
{/literal}
	...
	jQuery(document.body).on('hover', '.tip-inner .cunjo_socials_top_simple_tb li', function() { jQuery('.cunjo_tooltip').poshytip('show'); });
});
{/literal}
</script>
...
<div id="{$id}_modal_email" class="cunjo_modal" style="display: none;">
    ...
    <div class="cunjo_modal_body">
    	 <div id="sendemail" class="send-email_top_simple_tb">
         <form id="cunjo_share_email">
            ...
            <div class="cunjo-form-row">
                ...
                <div id="submitemail_top_simple_tb" class="cunjo-email-btn"><span class="iconz-mail-send"></span> <span>{#email_send#}</span></div>
