...
<div id="{$id}" class="Share-bar bar_top_tb {$position}_top_tb {$icons}_top_tb {if $width eq '100'}maxwidth_top_tb{/if}" showat="{$showat}">
    <ul class="top_tb">
        ...
        {else}
            <li class="cunjo_credits_top_tb {if isset($tooltip) && $tooltip == 'yes'}cunjo_tooltip{/if}" title="!Share"><a href="http://share.cunjo.com" target="_blank" class="cunjo_more_modal"><span class="iconz-cunjo"></span></a></li>
        {/if}
