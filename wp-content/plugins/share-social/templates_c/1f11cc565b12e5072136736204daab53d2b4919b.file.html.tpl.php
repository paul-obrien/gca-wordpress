<?php /* Smarty version Smarty-3.1.13, created on 2013-12-11 20:48:09
         compiled from "layouts/bottom_tab/html.tpl" */ ?>
<?php /*%%SmartyHeaderCode:80047859952a931f9d4e3f6-67682081%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1f11cc565b12e5072136736204daab53d2b4919b' => 
    array (
      0 => 'layouts/bottom_tab/html.tpl',
      1 => 1386818941,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '80047859952a931f9d4e3f6-67682081',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52a931fa38d506_37822174',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52a931fa38d506_37822174')) {function content_52a931fa38d506_37822174($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/home5/goalcoll/public_html/wp-content/plugins/share-social/Smarty-3.1.13/libs/plugins/function.math.php';
?><?php  $_config = new Smarty_Internal_Config("locale.conf", $_smarty_tpl->smarty, $_smarty_tpl);$_config->loadConfigVars($_smarty_tpl->tpl_vars['lang']->value, 'local'); ?>
...
<script type="text/javascript">
jQuery('.bar_btm_tb .cunjo_tooltip').poshytip({
...
;
	<?php if ($_smarty_tpl->tpl_vars['position']->value=='center'){?>margin-left:-<?php echo smarty_function_math(array('equation'=>"x / 2",'x'=>$_smarty_tpl->tpl_vars['width']->value),$_smarty_tpl);?>
%;<?php }?>
}
.show_btm_tb {
	background-color: <?php echo $_smarty_tpl->tpl_vars['bgcolor']->value;?>
...
.bar_btm_tb ul.btm_tb li:hover {
	background-color: <?php echo $_smarty_tpl->tpl_vars['bgcolor']->value;?>
 !important;
}
.bar_btm_tb ul.btm_tb li.cunjo_socials_holder_btm_tb:hover {
	background-color: transparent !important;
}
.bar_btm_tb li.cunjo_messages_holder_btm_tb li.cunjo_message_btm_tb, .bar_btm_tb li.cunjo_messages_holder_btm_tb li.cunjo_message_btm_tb a, .bar_btm_tb ul.btm_tb li.cunjo_socials a.email,
.bar_btm_tb ul.btm_tb li.cunjo_credits_btm_tb a, .bar_btm_tb ul.btm_tb li.close_btm_tb, .bar_btm_tb ul.btm_tb li.container_btm_tb, .show_btm_tb, .gotop_btm_tb {
	color: <?php echo $_smarty_tpl->tpl_vars['textcolor']->value;?>
 !important;
}
.bar_btm_tb li.cunjo_messages_holder_btm_tb li.cunjo_message_btn_btm_tb .cunjo_message_btn {
...
.bar_btm_tb ul.btm_tb li.cunjo_messages_holder_btm_tb li.cunjo_message_btn_btm_tb:hover {
	background-color: transparent !important;
}
...
" class="Share-bar bar_btm_tb <?php echo $_smarty_tpl->tpl_vars['position']->value;?>
_btm_tb <?php echo $_smarty_tpl->tpl_vars['icons']->value;?>
_btm_tb <?php if ($_smarty_tpl->tpl_vars['width']->value=='100'){?>maxwidth_btm_tb<?php }?>">
    <ul class="btm_tb">
    		<li class="close_btm_tb"><span class="iconz-contract"></span></li>
            <li class="gotop_btm_tb"><span class="iconz-arrow-up"></span></li>
        <?php if ($_smarty_tpl->tpl_vars['nocredits']->value==false){?>
            <li class="space_btm_tb"></li>
        <?php }else{ ?>
            <li class="cunjo_credits_btm_tb <?php if (isset($_smarty_tpl->tpl_vars['tooltip']->value)&&$_smarty_tpl->tpl_vars['tooltip']->value=='yes'){?>cunjo_tooltip<?php }?>" title="!Share"><a href="http://share.cunjo.com" target="_blank" class="cunjo_more_modal"><span class="iconz-cunjo"></span></a></li>
        <?php }?>
        <?php if (isset($_smarty_tpl->tpl_vars['message']->value)&&$_smarty_tpl->tpl_vars['message']->value!=''){?>
        <li class="cunjo_messages_holder_btm_tb <?php echo $_smarty_tpl->tpl_vars['message_pos']->value;?>
">
        	<ul class="cunjo_messages_btm_tb">
            	<li class="cunjo_message_icon <?php echo $_smarty_tpl->tpl_vars['messageicon']->value;?>
"></li>
                <li class="cunjo_message_btm_tb">
                	<div class="cunjo_message_inner_btm_tb" id="msg_btm_tb">
                        <?php echo $_smarty_tpl->tpl_vars['message']->value;?>

                	</div>
                </li>
                <li class="cunjo_message_btn_btm_tb">
...
" class="cunjo_message_btn"><?php echo $_smarty_tpl->tpl_vars['messagebtn']->value;?>
        ...
        <li class="cunjo_socials_holder_btm_tb <?php echo $_smarty_tpl->tpl_vars['socials_pos']->value;?>
">
        	<ul class="cunjo_socials_btm_tb">
...
<div class="show_btm_tb"><span class="iconz-expand"></span></div>
<script type="text/javascript">
...
';
	...
	jQuery(document.body).on('hover', '.tip-inner .cunjo_socials_btm_tb li', function() { jQuery('.cunjo_tooltip').poshytip('show'); });
});
...
"><?php echo $_smarty_tpl->tpl_vars['url']->value;?>
    ...
    <div class="cunjo_modal_body">
    	 <div id="sendemail" class="send-email_btm_tb">
...
"/> 
                ...
                <div id="submitemail_btm_tb" class="cunjo-email-btn"><span class="iconz-mail-send"></span> <span><?php echo $_smarty_tpl->getConfigVariable('email_send');?>
</span></div>
...
" />
            <?php echo $_smarty_tpl->tpl_vars['extraz_btm_tb']->value;?>
