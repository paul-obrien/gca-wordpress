<?php /* Smarty version Smarty-3.1.13, created on 2014-03-03 13:06:55
         compiled from "layouts/tiny_buttons/html.tpl" */ ?>
<?php /*%%SmartyHeaderCode:8845757505314e0df06fa10-16600823%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bf0518c57a71707791043e74f2fed6891edd4cc6' => 
    array (
      0 => 'layouts/tiny_buttons/html.tpl',
      1 => 1386818941,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '8845757505314e0df06fa10-16600823',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5314e0df400a90_06089500',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5314e0df400a90_06089500')) {function content_5314e0df400a90_06089500($_smarty_tpl) {?><?php  $_config = new Smarty_Internal_Config("locale.conf", $_smarty_tpl->smarty, $_smarty_tpl);$_config->loadConfigVars($_smarty_tpl->tpl_vars['lang']->value, 'local'); ?>
...
<style>
.bar_tiny_btns ul.tiny_btns li.cunjo_socials_holder_tiny_btns:hover {
	background-color: transparent !important;
}
.bar_tiny_btns .cunjo_socials_tiny_btns .cunjo_messages_holder_tiny_btns, .bar_tiny_btns ul.tiny_btns li.cunjo_socials a.email, .bar_tiny_btns ul.tiny_btns li.cunjo_credits_tiny_btns a, 
.bar_tiny_btns ul.tiny_btns li.close_tiny_btns, .bar_tiny_btns ul.tiny_btns li.container_tiny_btns, .show_tiny_btns {
	color: <?php echo $_smarty_tpl->tpl_vars['textcolor']->value;?>
 !important;
}
.bar_tiny_btns .sh-counter {
...
#<?php echo $_smarty_tpl->tpl_vars['id']->value;?>
 .cunjo_messages_holder_tiny_btns {
	font-size: 12px;
	font-weight: bold;
...
" class="Share-bar bar_tiny_btns <?php echo $_smarty_tpl->tpl_vars['icons']->value;?>
_tiny_btns <?php if ($_smarty_tpl->tpl_vars['counter']->value=='yes'){?>counter_format<?php }?>">
    <ul class="tiny_btns">
        <?php if (isset($_smarty_tpl->tpl_vars['socials']->value)&&$_smarty_tpl->tpl_vars['socials']->value!=''){?>
        <li class="cunjo_socials_holder_tiny_btns">
        	<ul class="cunjo_socials_tiny_btns">
            	<?php if (isset($_smarty_tpl->tpl_vars['message']->value)&&$_smarty_tpl->tpl_vars['message']->value!=''){?>
                <li class="cunjo_messages_holder_tiny_btns <?php echo $_smarty_tpl->tpl_vars['message_pos']->value;?>
">
...
?>
                ...
                <?php }else{ ?>
                    <li class="cunjo_credits_tiny_btns <?php if (isset($_smarty_tpl->tpl_vars['tooltip']->value)&&$_smarty_tpl->tpl_vars['tooltip']->value=='yes'){?>cunjo_tooltip<?php }?>" title="!Share"><a href="http://share.cunjo.com" target="_blank" class="cunjo_more_modal"></a></li>
                <?php }?>
            </ul>
        </li>
        <?php }?>
...
';
	...
	jQuery(document.body).on('hover', '.tip-inner .cunjo_socials_tiny_btns li', function() { jQuery('.cunjo_tooltip').poshytip('show'); });
...
"><?php echo $_smarty_tpl->tpl_vars['url']->value;?>
    ...
    <div class="cunjo_modal_body">
    	 <div id="sendemail" class="send-email_tiny_btns">
...
"/> 
                ...
                <div id="submitemail_tiny_btns" class="cunjo-email-btn"><span class="iconz-mail-send"></span> <span><?php echo $_smarty_tpl->getConfigVariable('email_send');?>
</span></div>
...
" />
            <?php echo $_smarty_tpl->tpl_vars['extraz_tiny_btns']->value;?>
