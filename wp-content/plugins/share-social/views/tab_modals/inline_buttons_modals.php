                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group span11" id="icons-group">
                            ...
                            <select style="width: 100%;" id="icons" name="options[icons]" class="select-icons" layout="inline_buttons">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group span11" id="placement-group">
                            ...
                            <select style="width: 100%;" id="placement" name="options[placement]" class="select-placement" layout="inline_buttons">
