<?php
	...
	$social_channels = $view_data['settings']['left_tab']['social_channels'];

	$bar_layout_design = $view_data['settings']['left_tab']['bar_layout_design'];

	$call_to_action = $view_data['settings']['left_tab']['call_to_action'];

	$visibility_settings = $view_data['settings']['left_tab']['visibility_settings'];
...
<div id="left_tab_social_channels" class="modal widget-settings" tabindex="-1" role="dialog" aria-labelledby="registerShareLabel" aria-hidden="true">
	 ...
	 <div class="modal-dialog">
      <div class="modal-content">
          ...
          <div class="modal-body">
                ...
                <div class="drag-links row">
                    ...
                    <div class="col-md-5">
                        ...
                        <form class="form-horizontal" id="social-channels-left_tab" novalidate="novalidate" title="<?php echo $social_channels['settings_category']; ?>">
          ...
          <div class="modal-footer">
            ...
            <button type="submit" class="btn btn-icon btn-primary circle_ok save-widget-settings" settings="#social-channels-left_tab" layout="left_tab" data-loading-text="loading..."><i class="appz-checkmark-circle-2"></i> Save</button>
...
<div id="left_tab_bar_layout_design" class="modal widget-settings" tabindex="-1" role="dialog" aria-labelledby="registerShareLabel" aria-hidden="true">
	 ...
	 <div class="modal-dialog">
      <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <form class="form-horizontal" id="bar-layout-left_tab" novalidate="novalidate" title="<?php echo $bar_layout_design['settings_category']; ?>">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group" id="bgcolor-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="bgcolor-left_tab" name="options[bgcolor]" value="<?php echo $bar_layout_design['bgcolor']; ?>" class="form-control"/>
        						<span class="input-group-btn">
                                	<button href="javascript:void(0)" class="btn undo-color" target="#bgcolor-left_tab" original="<?php echo $bar_layout_design['bgcolor']; ?>"><i class="appz-undo"></i> Undo</button>
        						</span>
                            </div>
        
                            <br/><br/>
        
                            <div class="palette" target="#bgcolor-left_tab"></div>
                        ...
                        <div class="form-group span11" id="icons-group">
                            ...
                            <select style="width: 100%;" id="icons" name="options[icons]" class="select-icons" layout="left_tab">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group" id="textcolor-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="textcolor-left_tab" name="options[textcolor]" value="<?php echo $bar_layout_design['textcolor']; ?>" class="form-control"/>
        						<span class="input-group-btn">
                                    <button href="javascript:void(0)" class="btn undo-color" target="#textcolor-left_tab" original="<?php echo $bar_layout_design['textcolor']; ?>"><i class="appz-undo"></i> Undo</button>
        						</span>
                            </div>
        
                            <br/><br/>
        
                            <div class="palette" target="#textcolor-left_tab"></div>
          ...
          <div class="modal-footer">
            ...
            <button type="submit" class="btn btn-icon btn-primary circle_ok save-widget-settings" settings="#bar-layout-left_tab" layout="left_tab" data-loading-text="loading..."><i class="appz-checkmark-circle-2"></i> Save</button>
...
<div id="left_tab_visibility_settings" class="modal widget-settings" tabindex="-1" role="dialog" aria-labelledby="registerShareLabel" aria-hidden="true">
	 ...
	 <div class="modal-dialog">
      <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <form class="form-horizontal" id="visibility-settings-left_tab" novalidate="novalidate" title="Visibility settings">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group span11" id="on_home-group">
                            ...
                            <div class="toggle-button" data-toggleButton-style-enabled="info">
                                ...
                                <input data-toggle="value" target_id="on_home-left_tab" target_name="options[on_home]" type="checkbox" value="1" <?php echo($visibility_settings['on_home'] == 0)? '': 'checked="checked"'; ?>/>
                        ...
                        <div class="form-group span11" id="on_posts-group">
                            ...
                            <div class="toggle-button" data-toggleButton-style-enabled="info">
                                ...
                                <input data-toggle="value" target_id="on_posts-left_tab" target_name="options[on_posts]" type="checkbox" value="1" <?php echo($visibility_settings['on_posts'] == 0)? '': 'checked="checked"'; ?>/>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group span11" id="on_pages-group">
                            ...
                            <div class="toggle-button" data-toggleButton-style-enabled="info">
                                ...
                                <input data-toggle="value" target_id="on_pages-left_tab" target_name="options[on_pages]" type="checkbox" value="1" <?php echo($visibility_settings['on_pages'] == 0)? '': 'checked="checked"'; ?>/>
          ...
          <div class="modal-footer">
            ...
            <button type="submit" class="btn btn-icon btn-primary circle_ok save-widget-settings" settings="#visibility-settings-left_tab" layout="left_tab" data-loading-text="loading..."><i class="appz-checkmark-circle-2"></i> Save</button>
...
<div id="preview_left_tab" class="modal widget-preview-modal" tabindex="-1" role="dialog" wp_address="<?php echo get_site_url(); ?>/?cunjo=left_tab" aria-hidden="true">
