...
<div id="top_tab_social_channels" class="modal widget-settings" tabindex="-1" role="dialog" aria-labelledby="registerShareLabel" aria-hidden="true">
...
<div id="top_tab_bar_layout_design" class="modal widget-settings" tabindex="-1" role="dialog" aria-labelledby="registerShareLabel" aria-hidden="true">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group" id="bgcolor-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="bgcolor-top_tab" name="options[bgcolor]" value="<?php echo $bar_layout_design['bgcolor']; ?>" class="form-control"/>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group" id="textcolor-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="textcolor-top_tab" name="options[textcolor]" value="<?php echo $bar_layout_design['textcolor']; ?>" class="form-control"/>
        						<span class="input-group-btn">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group" id="width-group">
                            ...
                            <div class="slider-bar-width-top_tab row">
        
                                <div class="col-md-3">
        							<div class="input-group">
                                        <input type="text" class="amount form-control" name="options[width]" id="width" />
...
<div id="top_tab_call_to_action" class="modal widget-settings" tabindex="-1" role="dialog" aria-labelledby="registerShareLabel" aria-hidden="true">
            ...
            <form class="form-horizontal" id="call-to-action-top_tab" novalidate="novalidate" title="<?php echo $call_to_action['settings_category']; ?>">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group span11" id="activatelink-group-top_tab">
                        ...
                        <div class="form-group" id="messagebtncolor-group-top_tab" <?php echo $link_settings; ?>>
        
                            <h5>Button background color</h5>
        
                            <div class="input-group">
        
                                <input type="text" id="messagebtncolor-top_tab" name="options[messagebtncolor]" value="<?php echo $call_to_action['messagebtncolor']; ?>" class="form-control"/>
        						<span class="input-group-btn">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group" id="messagebtn-group-top_tab" <?php echo $link_settings; ?>>
                        ...
                        <div class="form-group" id="messagebtntext-group-top_tab" <?php echo $link_settings; ?>>
        
                            <h5 style="margin-top: 1px;">Button text color</h5>
        
                            <div class="input-group">
        
                                <input type="text" id="messagebtntext-top_tab" name="options[messagebtntext]" value="<?php echo $call_to_action['messagebtntext']; ?>" class="form-control"/>
        						<span class="input-group-btn">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group" id="messagelink-group-top_tab" <?php echo $link_settings; ?>>
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="messagelink-top_tab" name="options[messagelink]" value="<?php echo $call_to_action['messagelink']; ?>" class="form-control"/>
...
<div id="top_tab_visibility_settings" class="modal widget-settings" tabindex="-1" role="dialog" aria-labelledby="registerShareLabel" aria-hidden="true">
...
<div id="preview_top_tab" class="modal widget-preview-modal" tabindex="-1" role="dialog" wp_address="<?php echo get_site_url(); ?>/?cunjo=top_tab" aria-hidden="true">
