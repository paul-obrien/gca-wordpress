    ...
    function add_style_scripts_frontend() {
        ...
        $validate_strings = array(
            ...
            'ErrMsg' => array(
                ...
                'slugexists' => __('The slug you entered is already registered. Please try a new slug.', 'upme'),
                'sluginvalid' => __('The slug is invalid. It may contain only letters, numbers, dashes, and underscores.', 'upme')
            ),
            'MeterMsg' => array(
                'similartousername' => __('Your password is too similar to your username.', 'upme'),
                'mismatch' => __('Both passwords do not match.', 'upme'),
        ...
        if (!wp_script_is('form-validate')) {
            ...
            $validate_strings = array(
                ...
                'ErrMsg' => array(
                    ...
                    'slugexists' => __('The slug you entered is already registered. Please try a new slug.', 'upme'),
                    'sluginvalid' => __('The slug is invalid. It may contain only letters, numbers, dashes, and underscores.', 'upme'),
                    'slugvalid' => __('Slug is available.', 'upme')
                ),
                'MeterMsg' => array(
                    'similartousername' => __('Your password is too similar to your username.', 'upme'),
                    'mismatch' => __('Both passwords do not match.', 'upme'),
