...
add_action('wp_ajax_upme_validate_edit_profile_slug', 'upme_validate_edit_profile_slug');
function upme_validate_edit_profile_slug() {

    $user_slug = isset($_POST['slug']) ? $_POST['slug'] : '';
    ...
    if (!empty($user_slug)) {
        ...
        //} else {
        //    echo json_encode(array("status" => TRUE, "msg" => "RegInvalidSlug"));
        //}
    } else {
        echo json_encode(array("status" => FALSE, "msg" => "RegEmptySlug"));
    }
