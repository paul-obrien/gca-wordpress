...
function upme_custom_scripts() {
    ...
    $custom_js_strings = array(
        ...
        'Messages' => array(
            ...
            'RegExistSlug' => __('Slug is already registered.', 'upme'),
            'RegValidSlug' => __('Slug is available', 'upme'),
            'RegInvalidSlug' => __('Invalid slug. Slugs can only contain letters, numbers, dashes, and underscores. No spaces', 'upme'),
            'RegEmptySlug' => __('Slug is empty.', 'upme'),
