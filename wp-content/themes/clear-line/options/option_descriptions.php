...
(4). Send me images and theme name, I\'ll include the theme to the next release', THEME_DOMAIN),
	...
	$shortname . '_bitly_login' => array(
		'title' 		=> __('Bit.ly Login', THEME_DOMAIN),
		'desc'			=> __('Login at shortening service site <a href="http://bit.ly">bit.ly</a>', THEME_DOMAIN),
	),
	$shortname . '_bitly_api_key' => array(
		'title' 		=> __('Bit.ly API Key', THEME_DOMAIN),
		'desc'			=> __('You can get your API Key in your <a href="https://bitly.com/a/account">bit.ly account</a> (you should to log in)', THEME_DOMAIN),
	),
